...
from .update_status.function_v2 import update_status as update_status_new
...
def generate_orders_report(data):
    msg = download_flag_func_orders(
        data["query_to_run"],
        data["get_selected_product_details"],
        data["auth_data"],
        data["ORDERS_DOWNLOAD_HEADERS"],
        data["hide_weights"],
        data["report_id"],
    )
    return msg
